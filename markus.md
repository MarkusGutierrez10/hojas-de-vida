...
Programador de software con dote de innovacion de problemas, conocimiento de varios lenguajes, capaz de autogestion, eficaz en proyectos, independiente, buenas habilidades de colaboracion de un equipo productivo
...
* conocimiento en HTML, CSS, Javascript, python, bootstrap, php, flutter, dart, etc.
...
* ### Tecnico en programación de software
    ...
    Centro Nacional Colombo Áleman SENA
